...
- **AI에게 원인만 물어봄** — [[hallucination]]의 가장 위험한 영역. 최소한 한 줄은 사람이 검증
...
- **Asking the AI for the cause alone** — the most dangerous corner of [[hallucination]]. At least one sentence verified by a human
...
- **AIに原因だけ尋ねる** — [[hallucination]]の最も危険な領域。最低一行は人が検証
